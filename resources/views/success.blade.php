...
@section('content')
    ...
    <div class="flex-wrap w-full">
        ...
        <div class="flex-wrap items-center w-full my-6 mx-0 text-center px-4">

            <div class="block my-12 max-w-3xl mx-auto  text-center rounded shadow-lg bg-green-200 text-green-600 font-sans font-semibold px-4 pt-4 pb-8 text-xl">
        ...
        <div class="flex-wrap items-center w-full mx-auto bg-indigo-900 py-4 border-t-2 border-b-2 border-indigo-900 shadow text-center my-8 py-8">
            ...
            <p class="text-center text-indigo-400 px-4">
            ...
            <div class="mx-auto max-w-xl mt-6 px-4">
