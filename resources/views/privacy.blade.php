    ...
    <div class="container w-full mx-auto px-2">
        ...
        <div class="my-4 mx-auto items-center max-w-3xl p-4 rounded shadow-lg bg-gray-100 border border-gray-300">
            ...
            <ul class="text-sm text-left text-gray-600 list-disc list-inside ml-2">
                ...
                <li class="my-2">We temporarily save an encrypted version of your data.</li>
            ...
            <p class="text-sm text-left text-gray-600 font-normal block my-2">
                ...
                All data is completely removed once the item expires or if you force expire it using the Delete button.
            </p>
            <hr class="my-6">
            ...
            <ul class="text-sm text-left text-gray-600 list-inside list-disc ml-2">
                <li>A cookie saves your session information for you encryption session.</li>
            ...
            <p class="text-sm text-left text-gray-600 font-normal block my-2">
                NotifiUs, LLC keeps its privacy policy under regular review and places any updates on this web page. This privacy policy was last updated on 4 July 2022.
            </p>
            <hr class="my-6">
